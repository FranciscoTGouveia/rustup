...
If a change affects the output of a particular command (e.g., `--help`), the associated snapshot can be regenerated by running the tests with `SNAPSHOTS=overwrite`.
